...
pkgbuild --root ./KextSNB --identifier com.chris1111.legacyVideoPatch.KextSNB.pkg --version 1 --install-location /tmp ./LegacyVideo-patch/BUILD-PACKAGE/KextSNB.pkg

pkgbuild --root ./KextNDRV --identifier com.chris1111.legacyVideoPatch.KextNDRV.pkg --version 1 --install-location /tmp ./LegacyVideo-patch/BUILD-PACKAGE/KextNDRV.pkg
...
pkgutil --expand ./LegacyVideo-patch/BUILD-PACKAGE/KextSNB.pkg /tmp/PackageDIR/kextsnb.pkg
pkgutil --expand ./LegacyVideo-patch/BUILD-PACKAGE/KextNDRV.pkg /tmp/PackageDIR/kextndrv.pkg
